...
export const Picker = defineComponent({
    ...
    setup(props, { slots, emit }) {
        ...
        const isCascade = computed(() => ['date-picker', 'cascade-picker'].includes(props.mode))
        ...
        const columns: any = isCascade.value ? [dates] : reactive([[...props.columns]])
        if (isCascade.value) {
        ...
        const pickerChange = (e: any, i: number) => {
            value[i] = e || ''
            if(isCascade.value) setColums(e, i)
        }
